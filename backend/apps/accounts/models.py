...
from backend.apps.accounts.managers import CustomUserManager
from backend.apps.common.models import IsDeletedModel
...
class User(IsDeletedModel, AbstractBaseUser, PermissionsMixin):
    ...
    first_name = models.CharField(max_length=25, verbose_name="First Name", null=True)
    ...
    account_type = models.CharField(
        max_length=20, choices=ACCOUNTS_TYPE_CHOICES, default="BUYER"
    )
